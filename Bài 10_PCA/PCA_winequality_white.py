...
data_X = np.array(df[['do axit co dinh','do axit de bay hoi','axit citric','duong du','clorua','luu huynh dioxit tu do','tong luu huynh dioxit','ty trong','pH','sunfat','ruou']].values)
...
for j in range(1,12):
    ...
    svc = tree.DecisionTreeClassifier(criterion = "gini")
...
sample_test = [['7','0.27','0.36','20.7','0.045','45','170','1.001','3','0.45','8.8']]
